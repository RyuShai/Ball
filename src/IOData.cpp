...
string IOData::GetLinkURL(string linkFileConfig)
{
	string data;
	string line;
	string url;
	ifstream config;
	config.open(linkFileConfig);
...
string IOData::GetCarPlateCascade(string linkFileConfig,int mode)
{
	string data;
	string line;
	string url;
...
string IOData::GetMotobikePlateCascade(string linkFileConfig)
{
	string data;
	string line;
	string url;
...
string IOData::GetCarPlatelogistic(string linkFileConfig)
{
	string data;
	string line;
	string url;
...
string IOData::GetMotobikePlatelogistic(string linkFileConfig)
{
	string data;
	string line;
	string url;
...
INPUT_MODE IOData::GetInputMode(string linkFileConfig)
{
	string data;
	string line;
	string mode;
...
DETECT_MODE IOData::GetDetectMode(string linkFileConfig)
{
	string data;
	string line;
	string mode;
...
std::string IOData::GetCongfigData(string linkFileConfig,std::string key)
{
	string data;
	string line;
	string url;
