...
class Tracker {
	...
	public:
		...
		//=========================================================================================
		bool searchSidelines(Mat& frame, int TID, int count, vector<Point>& newCandidates) {
...
//=========================================================================================
		void getNearestPlayersVctr1(Point match, vector<int>& pIndexes, vector<double>& pDistance) {
		...
		//=========================================================================================
		void ball_updateBallCandidate(BallCandidate* bc, Mat& frame, int TID) {
						...
						if (nearestPlayerDist < 15.0)
						{
							...
							***********************************************************/
							for (int i = 0; i < nCrds.size(); i++)
							{
								...
								getNearestPlayersVctr1(nCrds[i], nearbyP_Idx, nearbyP_Dist);
		...
		void getNearestPlayersVctr (BallCandidate* bc, vector<int>& pIndexes, vector<double>& pDistance, double maxDist) {
